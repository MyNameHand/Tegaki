...
The priority-based scanlator filter is adapted from [@AwkwardPeak7](https://github.com/AwkwardPeak7)'s
Mihon pull request [#2828](https://github.com/mihonapp/mihon/pull/2828) (unmerged upstream at the time
of writing). Any bugs in this fork's version of it are this fork's own.
